...
const DEFAULT_SLAVIC: SlavicCharacter = {
  ...
  skills: {
    Might: 1, Endurance: 1, Melee: 1, Crafting: 2,
    Stealth: 2, "Sleight of Hand": 1, Move: 2, Marksmanship: 1,
    Scouting: 3, Lore: 4, Survival: 3, Insight: 4,
    Manipulation: 3, Performance: 2, Healing: 4, "Animal Handling": 1,
  },
  talents: ["Spirit Caller", "Herb Lore", "Dream Walker"],
  wyrd: { current: 3, max: 3 },
  weapons: [{ name: "Oak Staff", grip: "2H", damage: 1, range: "Arm's Length" }],
